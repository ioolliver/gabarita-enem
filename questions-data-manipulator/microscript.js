const data = [
    ...
    {
        "preCommand": "![](https://enem.dev/2017/questions/3-ingles/0933a50a-d739-44ba-b540-de42213e3fcf.png)\n\n #### Reader’s Digest, set. 1993.",
        "command": "Nesse texto publicitário são utilizados recursos verbais e não verbais para transmitir a mensagem. Ao associar os termos anyplace e regret à imagem do texto, constata-se que o tema da propaganda é a importância da",
        "correct": 2,
        "identifier": "ENEM",
        "year": 2017,
        "abilityCode": 5,
    ...
    },
    {
        ...
        "command": "No que diz respeito à tragédia ocorrida em Burkesville, a autora da carta enviada ao The New York Times busca",
        "correct": 3,
        "identifier": "ENEM",
        "year": 2017,
        "abilityCode": 7,
    ...
    },
    {
        ...
        "command": "O comentário do texto II sobre o texto I evoca a mobilização da língua oral que, em determinados contextos,",
        "correct": 4,
        "identifier": "ENEM",
        "year": 2017,
        "abilityCode": 4,
    ...
    {
        "preCommand": "![](https://enem.dev/2017/questions/11/55ed62f2-789b-4797-9449-8f163efcac59.jpg)",
        "command": "O consumidor do século XXI, chamado de novo consumidor social, tende a se comportar de modo diferente do consumidor tradicional. Pela associação das características apresentadas no diagrama, infere-se que esse novo consumidor sofre influência da",
        "correct": 0,
        "identifier": "ENEM",
        "year": 2017,
        "abilityCode": 28,
    ...
    {
        "preCommand": "**O farrista**\n\nQuando o almirante Cabral\n\nPôs as patas no Brasil\n\nO anjo da guarda dos índios\n\nEstava passeando em Paris.\n\nQuando ele voltou de viagem\n\nO holandês já está aqui.\n\nO anjo respira alegre:\n\n“Não faz mal, isto é boa gente,\n\nVou arejar outra vez.”\n\nO anjo transpôs a barra,\n\nDiz adeus a Pernambuco,\n\nFaz barulho, vuco-vuco,\n\nTal e qual o zepelim\n\nMas deu um vento no anjo,\n\nEle perdeu a memória.\n\nE não voltou nunca mais.\n\n #### MENDES, M. **História do Brasil**. Rio de Janeiro: Nova Fronteira, 1992",
        "command": "A Obra de Murilo Mendes situa-se na fase inicial do Modernismo, cujas propostas estéticas transparecem, no poema, por um eu lírico que",
        "correct": 1,
        "identifier": "ENEM",
        "year": 2017,
        "abilityCode": 15,
    ...
    {
        "preCommand": "**Sítio Gerimum**\n\nEste é o meu lugar (…)\n\nMeu Gerimum é com g\n\nVocê pode ter estranhado\n\nGerimum em abundância\n\nAqui era plantado\n\nE com a letra g\n\nMeu lugar foi registrado.\n\n #### OLIVEIRA, H. D. **Língua Portuguesa,** n. 88, fev. 2013 (fragmento)",
        "command": "Nos versos de um menino de 12 anos, o emprego da palavra “Gerimum” grafada com a letra \“g\” tem por objetivo",
        "correct": 4,
        "identifier": "ENEM",
        "year": 2017,
        "abilityCode": 23,
    ...
    },
    {
        ...
        "command": "Os textos tratam de línguas de culturas completamente diferentes, cujas realidades se aproximam em função do(a)",
        "correct": 3,
        "identifier": "ENEM",
        "year": 2017,
        "abilityCode": 22,
    ...
    },
    {
        ...
        "command": "O texto trata da diferença de sentido entre vocábulos muito próximos. Essa diferença é apresentada considerando-se a(s)",
        "correct": 1,
        "identifier": "ENEM",
        "year": 2017,
        "abilityCode": 26,
    ...
    {
        "preCommand": "![](https://enem.dev/2017/questions/28/de217b18-c918-4279-a59c-131b0d8f4276.jpg)",
        "command": "Campanhas publicitárias podem evidenciar problemas sociais. O Cartaz tem como finalidade",
        "correct": 1,
        "identifier": "ENEM",
        "year": 2017,
        "abilityCode": 2,
    ...
    },
    {
        ...
        "command": "A linguagem cumpre diferentes funções no processo de comunicação. A função que predomina nos textos I e II",
        "correct": 1,
        "identifier": "ENEM",
        "year": 2017,
        "abilityCode": 19,
    ...
    {
        "preCommand": "**Contranarciso**  \nem mim  \neu vejo o outro  \ne outro  \ne outro\n\nenfim dezenas  \ntrens passando  \nvagões cheios de gente  \ncentenas  \no outro  \nque há em mim  \né você  \nvocê  \ne você  \nassim como  \neu estou em você  \neu estou nele  \nem nós  \ne só quando  \nestamos em nós  \nestamos em paz  \nmesmo que estejamos a sós\n\n #### Leminsky P. Toda poesia. São Paulo: Cia. das Letras, 2013.",
        "command": "A busca pela identidade constitui uma faceta da tradição literária, redimensionada pelo olhar contemporâneo. No poema, essa nova dimensão revela a",
        "correct": 3,
        "identifier": "ENEM",
        "year": 2017,
        "abilityCode": 15,
    ...
    {
        "preCommand": "![](https://enem.dev/2017/questions/34/e4b37290-3bc4-4ef6-b757-9065f855a1e6.png)",
        "command": "Os textos publicitários são produzidos para cumprir determinadas funções comunicativas. Os objetivos desse cartaz estão voltados para a conscientização dos brasileiros sobre a necessidade de",
        "correct": 1,
        "identifier": "ENEM",
        "year": 2017,
        "abilityCode": 2,
    ...
    {
        "preCommand": "![](https://enem.dev/2017/questions/36/1cdf0e43-8744-480a-9e9c-1a408d15b0cf.png)",
        "command": "A obra de Rubem Valentim apresenta emblemas que, baseando-se em signos de religiões afro-brasileiras, se transformam em produção artística. A obra Emblema 78 relaciona-se com o Modernismo em virtude da",
        "correct": 2,
        "identifier": "ENEM",
        "year": 2017,
        "abilityCode": 14,
    ...
    {
        "preCommand": "![](https://enem.dev/2017/questions/37/4d4a90d7-9743-432c-8710-dacb137ea2d5.png)",
        "command": "A instalação Dengo transformou a sala do MAM-SP em um ambiente singular, explorando como principal característica artística a",
        "correct": 0,
        "identifier": "ENEM",
        "year": 2017,
        "abilityCode": 12,
    ...
    {
        "preCommand": "![](https://enem.dev/2017/questions/41/6947db40-b30c-4455-afa0-b713f578c798.png)\n\n #### Revista Bolsa, 1986. In: CARRASCOZA, J. A. A evolução do texto publicitário: a associação de palavras como elemento de sedução na publicidade. São Paulo: Futura, 1999 (adaptado).",
        "command": "Nesse cartaz publicitário de uma empresa de papel e celulose, a combinação dos elementos verbais e não verbais visa",
        "correct": 4,
        "identifier": "ENEM",
        "year": 2017,
        "abilityCode": 21,
